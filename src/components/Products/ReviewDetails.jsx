...
const ReviewDetails = ({ rating }) => {
  return (
    <div>
      <div>
        <p className=" text-primary justify-center flex items-center gap-1 text-xs ">
          <Rating
            emptySymbol={
              <svg
...
const RevCard = ({ rating }) => {
  return (
    <div className="text-secondary border-b border-b-secondary/10">
      ...
      <p className="font-semibold text-secondary mb-1">{rating} Star</p>
      <p>
        Amazing value and great product! My only gripe is the strong rubber
        smell they have, which goes away after a while.
      </p>

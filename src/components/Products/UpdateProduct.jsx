...
import { useUpdateSingleProductMutation } from "../../redux/features/productApi/productApi";
...
const UpdateProduct = () => {
  ...
  const [updateSingleProduct, { isSuccess, data: updateData, isLoading }] =
    ...
    <div className="max-w-7xl px-5 lg:px-10 mx-auto py-10">
      ...
      <div className="border py-2 rounded-lg">
        <form className="w-full px-3 mt-4" onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-2 gap-3 py-2">
            <div>
              <label htmlFor="stock" className="block text-[15px]">
            ...
            <div>
              <label htmlFor="price" className="block text-[15px]">
          ...
          <div className="py-2">
            <label htmlFor="description" className="block text-[15px] py-1">

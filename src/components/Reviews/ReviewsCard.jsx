...
const ReviewsCard = ({ review }) => {
  return (
    <div className="flex flex-col justify-between rounded-md border border-[#2626264b] p-8">
      <div>
      ...
      <p className="my-4 mb-0 text-base font-normal leading-relaxed tracking-wide text-[#262626]">
      ...
      <div className="mt-6 flex items-center gap-2 ">
        ...
        <div>
          ...
          <p className="text-xs leading-relaxed tracking-wide text-gray-800">
